    ...
    fetch('https://api.cert.fmh.de/template', ).then((res) => {
        ...
        setTimeout(() => {
            ...
            box1.insertAdjacentHTML('beforeend', '<div class="first-box">\n' +
                ...
                '    </div>\n' +
                '    <div class="contact">\n' +
                '        <a href=\'https://www.fmh.de/contact\' target="_blank">Kontakt</a>\n' +
                '    </div>\n' +
                '</div>');
            ...
            box5.insertAdjacentHTML('beforeend', '<div class="background-primary">\n' +
                ...
                '                        <div class="column mb-0">\n' +
                '                            <p class="italic mb-1">\n'+
                '                              „Wir schätzen die FMH-Finanzberatung für ihre Seriosität in Bezug auf Zinsen und Bedingungen und ihre Unabhängigkeit von Anbietern.“\n'+
                '                            </p>\n' +
                '                            <p class="bolder text-secondary text-align-right">Franz Lücke, Strategischer Berater für Kredite und Finanzierungen</p>\n' +
                '                        </div>\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '            </div>\n' +
